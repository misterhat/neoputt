...
const LobbyServer = require('../lobby-server');
...
class LobbyMakeState {
    ...
    uploadLobby() {
        ...
        this.lobby = new LobbyServer(this.lobby);
        this.lobby.create((err, course) => {
            if (err) {
    ...
    start() {
        ...
        this.play.addEventListener('click', () => this.uploadLobby(), false);
