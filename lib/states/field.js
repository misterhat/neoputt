...
class FieldState {
        ...
        if (this.type === 'lobby') {
            ...
            this.chatInput.addEventListener('keyup', e => {
                ...
                if (e.keyCode === 13 && this.chatInput.value.length) {
                    // TODO this will use lobby.say
                    this.log.push({
                        msg: this.chatInput.value,
                        nick: this.lobby.nick
                    });
    ...
    draw() {
        ...
        if (this.type === 'lobby') {
            this.painter.drawChatLog(this.chatInput.value, this.log);
        }
        ...
        if (this.type === 'lobby') {
            this.dom.removeListener(this.focusListener, false);
        }
